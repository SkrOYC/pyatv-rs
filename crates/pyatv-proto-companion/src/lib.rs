...
//!
//! `docs/research/companion-port-spec.md` is the byte-level reference and every module here cites the pyatv line it was ported from. The layering matches upstream's, module for module:
//!
//! | Here | pyatv | Role |
//! |---|---|---|
...
//!
//! Its transport encryption is deliberately *not* HAP session framing, despite sharing the same pair-setup and pair-verify exchange. See `docs/research/crypto-pairing.md` §5.3 and `docs/research/companion-port-spec.md` §1.3:
//!
